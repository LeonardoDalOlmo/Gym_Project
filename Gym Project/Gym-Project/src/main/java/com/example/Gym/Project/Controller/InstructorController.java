...
public class InstructorController {
    ...
    public ResponseEntity<List<ModalityDTO>> findModality(@PathVariable Integer id){
        var modalities = service.findModality(id);

        return ResponseEntity.ok().body(modalities);
    }
